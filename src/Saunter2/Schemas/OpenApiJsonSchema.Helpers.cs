...
internal sealed partial class OpenApiJsonSchema
{
    ...
    public static List<T>? ReadList<T>(ref Utf8JsonReader reader)
    {
        ...
        if (reader.TokenType == JsonTokenType.StartArray)
        {
            ...
            {
                values.Add((T)JsonSerializer.Deserialize(ref reader, typeof(T), Microsoft.AspNetCore.OpenApi.OpenApiJsonSchemaContext.Default)!);
                reader.Read();
            }
    ...
    public static Dictionary<string, T>? ReadDictionary<T>(ref Utf8JsonReader reader)
    {
        ...
        while (reader.TokenType != JsonTokenType.EndObject)
        {
            ...
            reader.Read();
            values[key] = (T)JsonSerializer.Deserialize(ref reader, typeof(T), Microsoft.AspNetCore.OpenApi.OpenApiJsonSchemaContext.Default)!;
            reader.Read();
        }
